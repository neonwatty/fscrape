...
describe('Error Types', () => {
  ...
  describe('AggregateError', () => {
    ...
    it('should detect retryable errors in aggregate', () => {
      const errors = [new ValidationError('Validation failed'), new NetworkError('Network failed')];
      const aggregateError = new AggregateError(errors);
...
describe('ErrorHandler', () => {
  ...
  describe('Circuit Breaker', () => {
    ...
    it('should close circuit after success threshold', async () => {
      ...
      const result = await errorHandler.executeWithCircuitBreaker(mockOperation, 'test-circuit-2');
