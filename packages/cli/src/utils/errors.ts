...
export class DatabaseQueryError extends DatabaseError {
  ...
  constructor(
    ...
    if (sqlState) {
      ...
      isRetryable =
        sqlState.startsWith('40') || sqlState.startsWith('08') || sqlState.startsWith('57');
    }
...
export class DatabaseTransactionError extends DatabaseError {
  ...
  constructor(message: string, transactionId?: string, operation?: string, originalError?: Error) {
...
export class ParsingError extends BaseError {
  ...
  constructor(message: string, content?: string, position?: number, originalError?: Error) {
    super(
      message,
      'PARSING_ERROR',
      ErrorSeverity.MEDIUM,
...
export class EnvironmentConfigError extends ConfigurationError {
  ...
  constructor(message: string, environment?: string, missingEnvVars?: string[]) {
...
export class PlatformError extends BaseError {
  ...
  constructor(message: string, platform: string, platformCode?: string, originalError?: Error) {
    super(
      message,
