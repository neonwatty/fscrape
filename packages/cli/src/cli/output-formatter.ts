...
export class OutputFormatter {
  ...
  private formatPostsCSV(posts: ForumPost[]): void {
    const headers = ['id', 'title', 'author', 'score', 'comments', 'platform', 'url', 'created_at'];
  ...
  private formatPostsVerbose(posts: ForumPost[]): void {
    posts.forEach((post, index) => {
      ...
      console.log(chalk.gray('Created:'), new Date(post.createdAt).toISOString());

      if (post.updatedAt) {
        console.log(chalk.gray('Updated:'), new Date(post.updatedAt).toISOString());
      }
  ...
  private formatCommentsCSV(comments: Comment[]): void {
    const headers = ['id', 'post_id', 'author', 'content', 'score', 'platform', 'created_at'];
    console.log(headers.join(','));
  ...
  private formatCommentsVerbose(comments: Comment[]): void {
    comments.forEach((comment, index) => {
      ...
      console.log(chalk.gray('Created:'), new Date(comment.createdAt).toISOString());
