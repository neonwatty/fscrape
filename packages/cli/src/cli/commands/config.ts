 ...
 */
async function saveConfig(configPath: string, config: ConfigData): Promise<void> {
 ...
 */
async function interactiveConfig(currentConfig: ConfigData): Promise<ConfigData> {
