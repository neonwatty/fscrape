...
export class AdvancedLogger {
  ...
  isLevelEnabled(level: string): boolean {
    const levelValue = customLevels.levels[level as keyof typeof customLevels.levels];
    const currentLevelValue = customLevels.levels[this.config.level as keyof typeof customLevels.levels];
